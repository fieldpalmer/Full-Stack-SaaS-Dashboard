     ...
     return (
          <div className='fixed inset-0 z-50 flex items-center justify-center'>
               ...
               <div className='relative bg-gray-900/80 backdrop-blur-sm rounded-lg p-8 w-full max-w-md mx-4'>
                    ...
                    <h2 className='text-2xl font-bold mb-6 text-white'>Welcome to Media Tracker!</h2>

                    <div className='space-y-4 text-gray-300'>
                         <p>
                              Media Tracker is your personal dashboard for tracking and analyzing your favorite movies, books, and
                              music.
                         </p>
                         ...
                         <p className='pt-4'>
                              You can continue as a guest, but to save your data between visits, please sign in or create an
                              account.
                         </p>
                    </div>
