...
import { UserFavorites, MovieStats, BookStats, MusicStats, Movie, Book, Music } from '../types/interfaces';
...
const MyMedia = () => {
     ...
     const totalMovieStats: MovieStats = {
          ...
          avgRating: totalMovies.reduce((acc, movie) => acc + movie.rating, 0) / totalMovies.length || 0,
          avgPopularity: totalMovies.reduce((acc, movie) => acc + movie.popularity, 0) / totalMovies.length || 0,
          oldestMovie:
               totalMovies.length > 0 ? new Date(Math.min(...totalMovies.map((m) => new Date(m.release_date).getTime()))) : null,
          newestMovie:
               totalMovies.length > 0 ? new Date(Math.max(...totalMovies.map((m) => new Date(m.release_date).getTime()))) : null,
     ...
     const favoriteMovieStats: MovieStats = {
          ...
          avgRating: favorites.movies.reduce((acc, movie) => acc + movie.rating, 0) / favorites.movies.length || 0,
          avgPopularity: favorites.movies.reduce((acc, movie) => acc + movie.popularity, 0) / favorites.movies.length || 0,
          oldestMovie:
     ...
     const totalBookStats: BookStats = {
          ...
          oldestBook:
               totalBooks.length > 0 ? new Date(Math.min(...totalBooks.map((b) => new Date(b.publishedDate).getTime()))) : null,
          newestBook:
               totalBooks.length > 0 ? new Date(Math.max(...totalBooks.map((b) => new Date(b.publishedDate).getTime()))) : null,
     ...
     const totalMusicStats: MusicStats = {
          ...
          averageListeners: totalMusic.reduce((acc, artist) => acc + artist.listeners, 0) / totalMusic.length || 0,
     ...
     const favoriteMusicStats: MusicStats = {
          ...
          averageListeners: favorites.music.reduce((acc, artist) => acc + artist.listeners, 0) / favorites.music.length || 0,
          ...
          switch (type) {
               case 'movies': {
                    ...
                    return {
                         ...
                         popularityDifference: (movieFavorites.avgPopularity - movieTotal.avgPopularity).toFixed(1),
               ...
               case 'books': {
                    ...
                    return {
                         ...
                         isMoreDiverse:
                              bookFavorites.uniqueAuthors / bookFavorites.count > bookTotal.uniqueAuthors / bookTotal.count
                    };
               }
               case 'music': {
                    ...
                    return {
                         listenerDifference: (
                              ((musicFavorites.averageListeners - musicTotal.averageListeners) / musicTotal.averageListeners) *
                              100
                         ).toFixed(1),
     ...
     return (
          <div className='p-2 sm:p-6 min-h-[calc(100vh-4rem)] overflow-y-auto'>
               <h2 className='text-xl sm:text-2xl font-bold sm:mb-6 text-white'>My Media - Analysis & Insights</h2>
                                   ...
                                   <h3 className='text-xl font-semibold text-white'>
                                        ...
                                        {favorites.movies.length === 0 && (
                                             <Link
                                                  ...
                                                  className='text-sm text-pink-400 hover:text-pink-300 ml-2'
                                             >
                                                  (add movies to your favorites for more insights)
                                             </Link>
                                        )}
                                   </h3>
                              </div>
                                   ...
                                   <h3 className='text-xl font-semibold text-white'>
                                        ...
                                        {favorites.books.length === 0 && (
                                             <Link
                                                  ...
                                                  className='text-sm text-pink-400 hover:text-pink-300 ml-2'
                                             >
                                                  (add books to your favorites for more insights)
                                             </Link>
                                        )}
                                   </h3>
                              </div>
                                   ...
                                   <h3 className='text-xl font-semibold text-white'>
                                        ...
                                        {favorites.music.length === 0 && (
                                             <Link
                                                  ...
                                                  className='text-sm text-pink-400 hover:text-pink-300 ml-2'
                                             >
                                                  (add music to your favorites for more insights)
                                             </Link>
                                        )}
                                   </h3>
                              </div>
