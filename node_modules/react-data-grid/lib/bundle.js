...
const measuringCellClassname = "mlln6zg7-0-0-beta-51";
...
const cell = "cj343x07-0-0-beta-51";
const cellClassname = `rdg-cell ${cell}`;
const cellFrozen = "csofj7r7-0-0-beta-51";
...
const checkbox = "c1bn88vv7-0-0-beta-51";
...
const groupCellContent = "g1s9ylgp7-0-0-beta-51";
const groupCellContentClassname = `rdg-group-cell-content ${groupCellContent}`;
const caret = "cz54e4y7-0-0-beta-51";
...
const headerSortCellClassname = "h44jtk67-0-0-beta-51";
const headerSortName = "hcgkhxz7-0-0-beta-51";
...
function useCalculatedColumns({ rawColumns, defaultColumnOptions, getColumnWidth, viewportWidth, scrollLeft, enableVirtualization }) {
	...
	const defaultHeaderCellRenderer = defaultColumnOptions?.renderHeaderCell ?? renderHeaderCell;
...
//#endregion
//#region src/Cell.tsx
const cellCopied = "c6ra8a37-0-0-beta-51";
const cellCopiedClassname = `rdg-cell-copied ${cellCopied}`;
const cellDraggedOver = "cq910m07-0-0-beta-51";
const cellDraggedOverClassname = `rdg-cell-dragged-over ${cellDraggedOver}`;
function Cell({ column, colSpan, isCellSelected, isCopied, isDraggedOver, row: row$1, rowIdx, className, onClick, onDoubleClick, onContextMenu, onRowChange, selectCell, style,...props }) {
...
const cellDragHandle = "c1w9bbhr7-0-0-beta-51";
const cellDragHandleFrozenClassname = "c1creorc7-0-0-beta-51";
...
const cellEditing = "cis5rrm7-0-0-beta-51";
...
const cellSortableClassname = "c6l2wv17-0-0-beta-51";
const cellResizable = "c1kqdw7y7-0-0-beta-51";
const cellResizableClassname = `rdg-cell-resizable ${cellResizable}`;
const resizeHandleClassname = "r1y6ywlx7-0-0-beta-51";
const cellDraggableClassname = "rdg-cell-draggable";
const cellDragging = "c1bezg5o7-0-0-beta-51";
const cellDraggingClassname = `rdg-cell-dragging ${cellDragging}`;
const cellOver = "c1vc96037-0-0-beta-51";
...
function HeaderCell({ column, colSpan, rowIdx, isCellSelected, onColumnResize, onColumnsReorder, sortColumns, onSortColumnsChange, selectCell, shouldFocusGrid, direction, dragDropKey }) {
	...
	function onPointerDown(event) {
		...
		function onLostPointerCapture(event$1) {
			if (!hasDoubleClickedRef.current) onPointerMove(event$1);
...
const row = "r1upfr807-0-0-beta-51";
const rowClassname = `rdg-row ${row}`;
const rowSelected = "r190mhd37-0-0-beta-51";
const rowSelectedClassname = "rdg-row-selected";
const rowSelectedWithFrozenCell = "r139qu9m7-0-0-beta-51";
...
const headerRow = "h10tskcx7-0-0-beta-51";
...
const arrow = "a3ejtar7-0-0-beta-51";
...
const root = "rnvodz57-0-0-beta-51";
const rootClassname = `rdg ${root}`;
const viewportDragging = "vlqv91k7-0-0-beta-51";
const viewportDraggingClassname = `rdg-viewport-dragging ${viewportDragging}`;
const focusSinkClassname = "f1lsfrzw7-0-0-beta-51";
const focusSinkHeaderAndSummaryClassname = "f1cte0lg7-0-0-beta-51";

//#endregion
//#region src/SummaryCell.tsx
const summaryCellClassname = "s8wc6fl7-0-0-beta-51";
...
const summaryRow = "skuhp557-0-0-beta-51";
const topSummaryRow = "tf8l5ub7-0-0-beta-51";
	...
	function getViewportRows() {
		...
		for (let viewportRowIdx = startRowIdx; viewportRowIdx <= endRowIdx; viewportRowIdx++) {
			...
			rowElements.push(renderRow(key, {
				...
				rowClass,
				gridRowStart,
				copiedCellIdx: copiedCell !== null && copiedCell.row === row$1 ? columns.findIndex((c) => c.key === copiedCell.columnKey) : void 0,
...
const groupRow = "g1yxluv37-0-0-beta-51";
...
const textEditorInternalClassname = "t7vyx3i7-0-0-beta-51";
