(function (g, f) {
  ...
  if (typeof define === "function" && define.amd) {
    define(['@ag-grid-community/core', 'react', 'react-dom'], f);
  } else if (typeof module === "object" && module.exports) {
    module.exports = f(require('@ag-grid-community/core'), require('react'), require('react-dom'));
  } else {
    var m = hasExports ? f(require('@ag-grid-community/core'), require('react'), require('react-dom')) : f(g["@ag-grid-community/core"], g["react"], g["react-dom"]);
...
// community-modules/react/dist/package/index.esm.mjs
...
var GroupCellRenderer = (0, import_react3.forwardRef)((props, ref) => {
  ...
  const escapedValue = (0, import_core2._escapeString)(value, true);
...
var CustomWrapperComp = (params) => {
  ...
  return /* @__PURE__ */ import_react6.default.createElement(CustomContext.Provider, { value: { setMethods } }, /* @__PURE__ */ import_react6.default.createElement(CustomComponentClass, { key, ...props }));
};
...
var ReactComponent = class {
  constructor(reactComponent, portalManager, componentType, suppressFallbackMethods) {
    ...
    this.instanceCreated = this.isStatelessComponent() ? import_core4.AgPromise.resolve(false) : new import_core4.AgPromise((resolve) => {
  ...
  init(params) {
    ...
    return new import_core4.AgPromise((resolve) => this.createReactComponent(resolve));
  }
...
function updateFloatingFilterParent(params, model) {
  params.parentFilterInstance((instance) => {
    (instance.setModel(model) || import_core5.AgPromise.resolve()).then(() => {
...
function getInstance(wrapperComponent, callback) {
  const promise = wrapperComponent?.getInstance?.() ?? import_core6.AgPromise.resolve(void 0);
  promise.then((comp) => callback(comp));
}
function warnReactiveCustomComponents() {
  (0, import_core6._warnOnce)("As of v32, using custom components with `reactiveCustomComponents = false` is deprecated.");
}
...
var HeaderCellComp = ({ ctrl }) => {
  ...
  if (isAlive && !cssClassManager.current) {
    cssClassManager.current = new import_core12.CssClassManager(() => eGui.current);
  }
  const setRef2 = (0, import_react14.useCallback)((eRef) => {
    eGui.current = eRef;
    compBean.current = eRef ? context.createBean(new import_core12._EmptyBean()) : context.destroyBean(compBean.current);
    if (!eRef || !isAlive) {
      return;
    }
    const compProxy = {
      ...
      setAriaSort: (sort) => {
        if (eGui.current) {
          sort ? (0, import_core12._setAriaSort)(eGui.current, sort) : (0, import_core12._removeAriaSort)(eGui.current);
        }
      },
  ...
  return /* @__PURE__ */ import_react14.default.createElement("div", { ref: setRef2, className: "ag-header-cell", "col-id": colId, role: "columnheader" }, /* @__PURE__ */ import_react14.default.createElement("div", { ref: eResize, className: "ag-header-cell-resize", role: "presentation" }), /* @__PURE__ */ import_react14.default.createElement("div", { ref: eHeaderCompWrapper, className: "ag-header-cell-comp-wrapper", role: "presentation" }, reactUserComp && userCompStateless && /* @__PURE__ */ import_react14.default.createElement(UserCompClass, { ...userCompDetails.params }), reactUserComp && !userCompStateless && /* @__PURE__ */ import_react14.default.createElement(UserCompClass, { ...userCompDetails.params, ref: userCompRef })));
};
...
var HeaderFilterCellComp = ({ ctrl }) => {
  ...
  const setRef2 = (0, import_react15.useCallback)((eRef) => {
    eGui.current = eRef;
    compBean.current = eRef ? context.createBean(new import_core13._EmptyBean()) : context.destroyBean(compBean.current);
    if (!eRef) {
      return;
    }
    userCompPromise.current = new import_core13.AgPromise((resolve) => {
  ...
  const reactUserComp = userCompDetails && userCompDetails.componentFromFramework;
  const UserCompClass = userCompDetails && userCompDetails.componentClass;
  return /* @__PURE__ */ import_react15.default.createElement("div", { ref: setRef2, className, role: "gridcell" }, /* @__PURE__ */ import_react15.default.createElement("div", { ref: eFloatingFilterBody, className: bodyClassName, role: "presentation" }, reactUserComp && !reactiveCustomComponents && /* @__PURE__ */ import_react15.default.createElement(UserCompClass, { ...userCompDetails.params, ref: userCompStateless ? () => {
  } : userCompRef }), reactUserComp && reactiveCustomComponents && /* @__PURE__ */ import_react15.default.createElement(
    ...
    /* @__PURE__ */ import_react15.default.createElement(UserCompClass, { ...floatingFilterProps })
...
var HeaderGroupCellComp = ({ ctrl }) => {
  ...
  const setRef2 = (0, import_react16.useCallback)((eRef) => {
    eGui.current = eRef;
    compBean.current = eRef ? context.createBean(new import_core14._EmptyBean()) : context.destroyBean(compBean.current);
    if (!eRef) {
      return;
    }
    const compProxy = {
  ...
  const reactUserComp = userCompDetails && userCompDetails.componentFromFramework;
  const UserCompClass = userCompDetails && userCompDetails.componentClass;
  return /* @__PURE__ */ import_react16.default.createElement("div", { ref: setRef2, className, "col-id": colId, role: "columnheader", "aria-expanded": ariaExpanded }, /* @__PURE__ */ import_react16.default.createElement("div", { ref: eHeaderCompWrapper, className: "ag-header-cell-comp-wrapper", role: "presentation" }, reactUserComp && userCompStateless && /* @__PURE__ */ import_react16.default.createElement(UserCompClass, { ...userCompDetails.params }), reactUserComp && !userCompStateless && /* @__PURE__ */ import_react16.default.createElement(UserCompClass, { ...userCompDetails.params, ref: userCompRef })), /* @__PURE__ */ import_react16.default.createElement("div", { ref: eResize, "aria-hidden": resizableAriaHidden, className: resizableClassName }));
};
...
var HeaderRowComp = ({ ctrl }) => {
  ...
  const setRef2 = (0, import_react13.useCallback)((eRef) => {
    eGui.current = eRef;
    compBean.current = eRef ? context.createBean(new import_core11._EmptyBean()) : context.destroyBean(compBean.current);
    if (!eRef) {
      return;
    }
    const compProxy = {
  ...
  const createCellJsx = (0, import_react13.useCallback)((cellCtrl) => {
    switch (ctrl.getType()) {
      case import_core11.HeaderRowType.COLUMN_GROUP:
        return /* @__PURE__ */ import_react13.default.createElement(headerGroupCellComp_default, { ctrl: cellCtrl, key: cellCtrl.instanceId });
      case import_core11.HeaderRowType.FLOATING_FILTER:
        return /* @__PURE__ */ import_react13.default.createElement(headerFilterCellComp_default, { ctrl: cellCtrl, key: cellCtrl.instanceId });
      default:
        return /* @__PURE__ */ import_react13.default.createElement(headerCellComp_default, { ctrl: cellCtrl, key: cellCtrl.instanceId });
    }
  }, []);
  return /* @__PURE__ */ import_react13.default.createElement("div", { ref: setRef2, className, role: "row", style, "aria-rowindex": ariaRowIndex }, cellCtrls.map(createCellJsx));
};
...
var HeaderRowContainerComp = ({ pinned }) => {
  ...
  const setRef2 = (0, import_react12.useCallback)((eRef) => {
    eGui.current = eRef;
    headerRowCtrlRef.current = eRef ? context.createBean(new import_core10.HeaderRowContainerCtrl(pinned)) : context.destroyBean(headerRowCtrlRef.current);
    if (!eRef) {
      return;
    }
    const compProxy = {
  ...
  return /* @__PURE__ */ import_react12.default.createElement(import_react12.default.Fragment, null, pinnedLeft && /* @__PURE__ */ import_react12.default.createElement(
    "div",
    {
      ref: setRef2,
    ...
    insertRowsJsx()
  ), pinnedRight && /* @__PURE__ */ import_react12.default.createElement(
    "div",
    {
      ref: setRef2,
    ...
    insertRowsJsx()
  ), centre && /* @__PURE__ */ import_react12.default.createElement("div", { ref: setRef2, className: "ag-header-viewport " + className, role: "presentation" }, /* @__PURE__ */ import_react12.default.createElement("div", { ref: eCenterContainer, className: "ag-header-container", role: "rowgroup" }, insertRowsJsx())));
};
...
var GridHeaderComp = () => {
  ...
  const setRef2 = (0, import_react11.useCallback)((eRef) => {
    eGui.current = eRef;
    gridCtrlRef.current = eRef ? context.createBean(new import_core9.GridHeaderCtrl()) : context.destroyBean(gridCtrlRef.current);
    if (!eRef)
      return;
    const compProxy = {
      addOrRemoveCssClass: (name, on) => setCssClasses((prev) => prev.setClass(name, on)),
...
var CellEditorComponentProxy = class {
  constructor(cellEditorParams, refreshProps) {
    ...
    this.refreshProps = refreshProps;
    this.instanceCreated = new import_core18.AgPromise((resolve) => {
      this.resolveInstanceCreated = resolve;
    });
...
var PopupEditorComp = (props) => {
  ...
  return /* @__PURE__ */ import_react21.default.createElement(import_react21.default.Fragment, null, popupEditorWrapper && props.wrappedContent && (0, import_react_dom3.createPortal)(props.wrappedContent, popupEditorWrapper.getGui()));
};
...
var jsxEditorProxy = (editDetails, CellEditorClass, setRef2) => {
  ...
  return /* @__PURE__ */ import_react20.default.createElement(
    ...
    isStateless ? /* @__PURE__ */ import_react20.default.createElement(CellEditorClass, { ...props }) : /* @__PURE__ */ import_react20.default.createElement(CellEditorClass, { ...props, ref: (ref) => compProxy.setRef(ref) })
  );
};
var jsxEditor = (editDetails, CellEditorClass, setRef2) => {
  const newFormat = editDetails.compProxy;
  return /* @__PURE__ */ import_react20.default.createElement(import_react20.default.Fragment, null, newFormat ? jsxEditorProxy(editDetails, CellEditorClass, setRef2) : /* @__PURE__ */ import_react20.default.createElement(CellEditorClass, { ...editDetails.compDetails.params, ref: setRef2 }));
};
var jsxEditValue = (editDetails, setCellEditorRef, eGui, cellCtrl, jsEditorComp) => {
  ...
  return /* @__PURE__ */ import_react20.default.createElement(import_react20.default.Fragment, null, reactInlineEditor && jsxEditor(editDetails, CellEditorClass, setCellEditorRef), reactPopupEditor && /* @__PURE__ */ import_react20.default.createElement(
  ...
  ), jsPopupEditor && jsEditorComp && /* @__PURE__ */ import_react20.default.createElement(
    popupEditorComp_default,
    {
      editDetails,
      cellCtrl,
...
var jsxShowValue = (showDetails, key, parentId, cellRendererRef, showCellWrapper, reactCellRendererStateless, setECellValue) => {
  ...
  const bodyJsxFunc = () => /* @__PURE__ */ import_react20.default.createElement(import_react20.default.Fragment, null, noCellRenderer && /* @__PURE__ */ import_react20.default.createElement(import_react20.default.Fragment, null, valueForNoCellRenderer), reactCellRenderer && !reactCellRendererStateless && /* @__PURE__ */ import_react20.default.createElement(CellRendererClass, { ...compDetails.params, key, ref: cellRendererRef }), reactCellRenderer && reactCellRendererStateless && /* @__PURE__ */ import_react20.default.createElement(CellRendererClass, { ...compDetails.params, key }));
  return /* @__PURE__ */ import_react20.default.createElement(import_react20.default.Fragment, null, showCellWrapper ? /* @__PURE__ */ import_react20.default.createElement("span", { role: "presentation", id: `cell-${parentId}`, className: "ag-cell-value", ref: setECellValue }, bodyJsxFunc()) : bodyJsxFunc());
};
var CellComp = ({
  cellCtrl,
  printLayout,
  ...
  if (!cssClassManager.current) {
    cssClassManager.current = new import_core17.CssClassManager(() => eGui.current);
  }
      ...
      const addComp = (comp) => {
        if (comp) {
          ...
          cellWrapperDestroyFuncs.current.push(() => {
            context.destroyBean(comp);
            (0, import_core17._removeFromParent)(eGui2);
          });
        }
        return comp;
      };
  ...
  const setRef2 = (0, import_react20.useCallback)((eRef) => {
    eGui.current = eRef;
    compBean.current = eRef ? context.createBean(new import_core17._EmptyBean()) : context.destroyBean(compBean.current);
    if (!eRef || !cellCtrl) {
      return;
    }
    const compProxy = {
  ...
  const showContents = () => /* @__PURE__ */ import_react20.default.createElement(import_react20.default.Fragment, null, renderDetails != null && jsxShowValue(
    renderDetails,
    renderKey,
    instanceId,
    cellRendererRef,
  ...
  return /* @__PURE__ */ import_react20.default.createElement("div", { ref: setRef2, style: userStyles, role: cellAriaRole, "col-id": colIdSanitised, onBlur }, showCellWrapper ? /* @__PURE__ */ import_react20.default.createElement("div", { className: "ag-cell-wrapper", role: "presentation", ref: setCellWrapperRef }, showContents()) : showContents());
};
...
var RowComp = ({ rowCtrl, containerType }) => {
  ...
  if (!cssClassManager.current) {
    cssClassManager.current = new import_core16.CssClassManager(() => eGui.current);
  }
  const setRef2 = (0, import_react19.useCallback)((eRef) => {
    eGui.current = eRef;
    compBean.current = eRef ? context.createBean(new import_core16._EmptyBean()) : context.destroyBean(compBean.current);
    if (!eRef) {
  ...
  const showCellsJsx = () => cellCtrls?.map((cellCtrl) => /* @__PURE__ */ import_react19.default.createElement(
    cellComp_default,
    {
      cellCtrl,
  ...
  const showFullWidthFrameworkJsx = () => {
    ...
    return /* @__PURE__ */ import_react19.default.createElement(import_react19.default.Fragment, null, reactFullWidthCellRendererStateless ? /* @__PURE__ */ import_react19.default.createElement(FullWidthComp, { ...fullWidthCompDetails.params }) : /* @__PURE__ */ import_react19.default.createElement(FullWidthComp, { ...fullWidthCompDetails.params, ref: fullWidthCompRef }));
  };
...
var RowContainerComp = ({ name }) => {
  ...
  const buildContainer = () => /* @__PURE__ */ import_react18.default.createElement("div", { className: containerClasses, ref: setContainerRef, role: "rowgroup" }, rowCtrlsOrdered.map((rowCtrl) => /* @__PURE__ */ import_react18.default.createElement(rowComp_default, { rowCtrl, containerType: containerOptions.type, key: rowCtrl.instanceId })));
...
var GridBodyComp = () => {
  ...
  if (!cssClassManager.current) {
    cssClassManager.current = new import_core8.CssClassManager(() => eRoot.current);
  }
  ...
  const setRef2 = (0, import_react10.useCallback)((eRef) => {
    ...
    addComp(eRef, import_core8.FakeHScrollComp, " AG Fake Horizontal Scroll ");
    addComp(eRef, import_core8.OverlayWrapperComponent, " AG Overlay Wrapper ");
    if (eBody.current) {
      addComp(eBody.current, import_core8.FakeVScrollComp, " AG Fake Vertical Scroll ");
    }
    const compProxy = {
      setRowAnimationCssOnBodyViewport: setRowAnimationClass,
      setColumnCount: (count) => {
        if (eRoot.current) {
          (0, import_core8._setAriaColCount)(eRoot.current, count);
        }
      },
      setRowCount: (count) => {
        if (eRoot.current) {
          (0, import_core8._setAriaRowCount)(eRoot.current, count);
        }
      },
      setTopHeight,
      setBottomHeight,
    ...
    const ctrl = context.createBean(new import_core8.GridBodyCtrl());
  ...
  const createRowContainer = (container) => /* @__PURE__ */ import_react10.default.createElement(rowContainerComp_default, { name: container, key: `${container}-container` });
  const createSection = ({
    section,
    children,
    className,
    style
  }) => /* @__PURE__ */ import_react10.default.createElement("div", { ref: section, className, role: "presentation", style }, children.map(createRowContainer));
  return /* @__PURE__ */ import_react10.default.createElement("div", { ref: setRef2, className: rootClasses, role: "treegrid" }, /* @__PURE__ */ import_react10.default.createElement(gridHeaderComp_default, null), createSection({
    section: eTop,
    className: topClasses,
    style: topStyle,
    children: ["topLeft", "topCenter", "topRight", "topFullWidth"]
  }), /* @__PURE__ */ import_react10.default.createElement("div", { className: bodyClasses, ref: eBody, role: "presentation" }, createSection({
...
var TabGuardCompRef = (props, forwardRef4) => {
  ...
  const setupCtrl = (0, import_react24.useCallback)(() => {
    ...
    if (topTabGuard && bottomTabGuard) {
      ...
      tabGuardCtrlRef.current = context.createBean(
        new import_core19.TabGuardCtrl({
          comp: compProxy,
  ...
  const createTabGuard = (side) => {
    const className = side === "top" ? import_core19.TabGuardClassNames.TAB_GUARD_TOP : import_core19.TabGuardClassNames.TAB_GUARD_BOTTOM;
    return /* @__PURE__ */ import_react24.default.createElement(
      "div",
      {
        className: `${import_core19.TabGuardClassNames.TAB_GUARD} ${className}`,
        role: "presentation",
...
var GridComp = ({ context }) => {
  ...
  const setRef2 = (0, import_react9.useCallback)((eRef) => {
    ...
    gridCtrlRef.current = eRef ? context.createBean(new import_core7.GridCtrl()) : context.destroyBean(gridCtrlRef.current);
  ...
  return /* @__PURE__ */ import_react9.default.createElement("div", { ref: setRef2, className: rootWrapperClasses, style: topStyle, role: "presentation" }, /* @__PURE__ */ import_react9.default.createElement("div", { className: rootWrapperBodyClasses, ref: setGridBodyParent, role: "presentation" }, initialised && eGridBodyParent && beans && /* @__PURE__ */ import_react9.default.createElement(BeansContext.Provider, { value: beans }, /* @__PURE__ */ import_react9.default.createElement(
    ...
    // hangs the UI)
    /* @__PURE__ */ import_react9.default.createElement(gridBodyComp_default, null)
  ))));
};
var gridComp_default = (0, import_react9.memo)(GridComp);
var RenderStatusService = class extends import_core20.BeanStub {
  wireBeans(beans) {
...
var AgGridReactUi = (props) => {
  ...
  const setRef2 = (0, import_react2.useCallback)((eRef) => {
    ...
    const mergedGridOps = (0, import_core._combineAttributesAndGridOptions)(props.gridOptions, props);
    ...
    const gridParams = {
      providedBeanInstances: {
        frameworkComponentWrapper: new ReactFrameworkComponentWrapper(
          ...
          mergedGridOps.reactiveCustomComponents ?? (0, import_core._getGlobalGridOption)("reactiveCustomComponents") ?? true
        ),
        renderStatusService
      },
      modules,
    ...
    const gridCoreCreator = new import_core.GridCoreCreator();
  ...
  (0, import_react2.useEffect)(() => {
    ...
    processWhenReady(() => {
      if (apiRef.current) {
        (0, import_core._processOnChange)(changes, apiRef.current);
      }
    });
  }, [props]);
  return /* @__PURE__ */ import_react2.default.createElement("div", { style, className: props.className, ref: setRef2 }, context && !context.isDestroyed() ? /* @__PURE__ */ import_react2.default.createElement(gridComp_default, { context }) : null, portalManager.current?.getPortals() ?? null);
};
...
var ReactFrameworkComponentWrapper = class extends import_core.BaseComponentWrapper {
...
var DetailCellRenderer = (0, import_react2.forwardRef)((props, ref) => {
  ...
  const parentModules = (0, import_react2.useMemo)(() => import_core.ModuleRegistry.__getGridRegisteredModules(props.api.getGridId()), [props]);
      ...
      const checkRowSizeFunc = () => {
        ...
        if (clientHeight != null && clientHeight > 0) {
          const updateRowHeightFunc = () => {
            ...
            if ((0, import_core._isClientSideRowModel)(gos) || (0, import_core._isServerSideRowModel)(gos)) {
  ...
  return /* @__PURE__ */ import_react2.default.createElement("div", { className: topClassName, ref: setRef2 }, detailGridOptions && /* @__PURE__ */ import_react2.default.createElement(
    AgGridReactUi,
    {
...
var ReactFrameworkOverrides = class extends import_core.VanillaFrameworkOverrides {
...
var AgGridReact = class extends import_react.Component {
  ...
  render() {
    return /* @__PURE__ */ import_react.default.createElement(AgGridReactUi, { ...this.props, setGridApi: this.setGridApi });
  }
};
