...
// community-modules/react/src/shared/customComp/dragAndDropImageComponentWrapper.ts
...
var HeaderCellComp = ({ ctrl }) => {
  ...
  if (isAlive && !cssClassManager.current) {
    cssClassManager.current = new import_core6.CssClassManager(() => eGui.current);
  }
  const setRef2 = (0, import_react7.useCallback)((eRef) => {
    eGui.current = eRef;
    compBean.current = eRef ? context.createBean(new import_core6._EmptyBean()) : context.destroyBean(compBean.current);
    if (!eRef || !isAlive) {
      return;
    }
    const compProxy = {
      ...
      setAriaSort: (sort) => {
        if (eGui.current) {
          sort ? (0, import_core6._setAriaSort)(eGui.current, sort) : (0, import_core6._removeAriaSort)(eGui.current);
        }
      },
...
var HeaderFilterCellComp = ({ ctrl }) => {
  ...
  const setRef2 = (0, import_react8.useCallback)((eRef) => {
    eGui.current = eRef;
    compBean.current = eRef ? context.createBean(new import_core7._EmptyBean()) : context.destroyBean(compBean.current);
    if (!eRef) {
      return;
    }
    userCompPromise.current = new import_core7.AgPromise((resolve) => {
...
var HeaderGroupCellComp = ({ ctrl }) => {
  ...
  const colId = (0, import_react9.useMemo)(() => ctrl.getColId(), []);
  ...
  const setRef2 = (0, import_react9.useCallback)((eRef) => {
    eGui.current = eRef;
    compBean.current = eRef ? context.createBean(new import_core8._EmptyBean()) : context.destroyBean(compBean.current);
    if (!eRef) {
      return;
    }
    const compProxy = {
...
var HeaderRowComp = ({ ctrl }) => {
  ...
  const setRef2 = (0, import_react10.useCallback)((eRef) => {
    eGui.current = eRef;
    compBean.current = eRef ? context.createBean(new import_core9._EmptyBean()) : context.destroyBean(compBean.current);
    if (!eRef) {
      return;
    }
    const compProxy = {
...
var GridHeaderComp = () => {
  ...
  const setRef2 = (0, import_react12.useCallback)((eRef) => {
    eGui.current = eRef;
    gridCtrlRef.current = eRef ? context.createBean(new import_core11.GridHeaderCtrl()) : context.destroyBean(gridCtrlRef.current);
    if (!eRef)
      return;
    const compProxy = {
      addOrRemoveCssClass: (name, on) => setCssClasses((prev) => prev.setClass(name, on)),
...
var PopupEditorComp = (props) => {
  ...
  const { context, popupService, localeService, gos, editService } = (0, import_react15.useContext)(BeansContext);
  useEffectOnce(() => {
...
var RowContainerComp = ({ name }) => {
  ...
  const containerOptions = (0, import_react19.useMemo)(() => (0, import_core15._getRowContainerOptions)(name), [name]);
...
// community-modules/react/src/reactUi/gridBodyComp.tsx
var GridBodyComp = () => {
  const { context, resizeObserverService } = (0, import_react20.useContext)(BeansContext);
  ...
  const setRef2 = (0, import_react20.useCallback)((eRef) => {
    ...
    addComp(eRef, import_core16.FakeHScrollComp, " AG Fake Horizontal Scroll ");
    addComp(eRef, import_core16.OverlayWrapperComponent, " AG Overlay Wrapper ");
    if (eBody.current) {
  ...
  return /* @__PURE__ */ import_react20.default.createElement("div", { ref: setRef2, className: rootClasses, role: "treegrid" }, /* @__PURE__ */ import_react20.default.createElement(gridHeaderComp_default, null), createSection({
    section: eTop,
...
var GridComp = ({ context }) => {
  ...
  const [gridThemeClass, setGridThemeClass] = (0, import_react22.useState)("");
  ...
  const setRef2 = (0, import_react22.useCallback)((eRef) => {
    ...
    gridCtrlRef.current = eRef ? context.createBean(new import_core18.GridCtrl()) : context.destroyBean(gridCtrlRef.current);
    ...
    const gridParams = {
      providedBeanInstances: {
        frameworkComponentWrapper: new ReactFrameworkComponentWrapper(
          ...
          mergedGridOps.reactiveCustomComponents ?? (0, import_core20._getGlobalGridOption)("reactiveCustomComponents") ?? true
        ),
        renderStatusService
      },
      modules,
...
var DetailCellRenderer = (0, import_react23.forwardRef)((props, ref) => {
  const { ctrlsFactory, context, gos, resizeObserverService, rowModel } = (0, import_react23.useContext)(BeansContext);
  ...
  const parentModules = (0, import_react23.useMemo)(() => import_core20.ModuleRegistry.__getGridRegisteredModules(props.api.getGridId()), [props]);
      ...
      const checkRowSizeFunc = () => {
        ...
        if (clientHeight != null && clientHeight > 0) {
          const updateRowHeightFunc = () => {
            ...
            if ((0, import_core20._isClientSideRowModel)(gos) || (0, import_core20._isServerSideRowModel)(gos)) {
